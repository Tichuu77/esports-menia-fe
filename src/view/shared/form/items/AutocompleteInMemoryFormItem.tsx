...
function AutocompleteInMemoryFormItem(props: any) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex gap-3">
        <div className="flex-1">
          <Select
            ...
            placeholder={placeholder || 'Select from available options...'}
        ...
        <div className="flex items-center gap-2">
          {loading ? (
            <>
              ...
              <span className="font-medium text-blue-700">Loading options...</span>
            </>
          ) : (
            <>
              <div className="w-2 h-2 rounded-full bg-blue-500" />
              <span className="font-medium">
                {fullDataSource.length} {fullDataSource.length === 1 ? 'option' : 'options'} available
              </span>
            </>
          )}
        </div>
      ...
      {Boolean(hint) && !errorMessage && !loading && (
...
export default React.memo(AutocompleteInMemoryFormItem);